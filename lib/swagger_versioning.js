                ...
                _.forEach(oldPath, function(oldOperation, methodKey){
                    if(newPath[methodKey]){
                        ...
                        if(oldOperation.operationId !== newOperation.operationId){
                            addBreakingError(breakingPaths, MAJOR_CHANGE, pathKey + " " + methodKey + " operation ID changed from " + oldOperation.operationId + " to " + newOperation.operationId);
                        }

                        if(oldOperation.description !== newOperation.description){
                            addBreakingError(breakingPaths, POINT_CHANGE, pathKey + " " + methodKey + " operation description changed " + oldOperation.operationId);
                        }

                        if(oldOperation.summary !== newOperation.summary){
                            addBreakingError(breakingPaths, POINT_CHANGE, pathKey + " " + methodKey + " operation summary changed " + oldOperation.operationId);
                        }
                        ...
                        addBreakingError(breakingPaths, MAJOR_CHANGE, "Method  " + methodKey + " for " + pathKey + " was removed");
                    }
                });
