    ...
    return{
        ...
        */
        updateVersionFile: function(swaggerDiff, versionFilePath){
            ...
            console.log("Current version: " + getVersionString(version))
            ...
            if(versionChanged){
                ...
                console.log("New version: " + getVersionString(version));
            }else{
