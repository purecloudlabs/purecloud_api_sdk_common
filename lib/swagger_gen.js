...
module.exports = function(){
    ...
    var EXCLUDE_NOTIFICATIONS = process.env.EXCLUDE_NOTIFICATIONS;
    // This is a temporary workaround. Remove this when it's not needed.
    var DONT_USE_VENDOR_EXTENSION_OPERATION = process.env.DONT_USE_VENDOR_EXTENSION_OPERATION;
    var operationIds = [];
    ...
    function processSwagger(swagger){
        ...
        if (DONT_USE_VENDOR_EXTENSION_OPERATION != 'true') {
                    ...
                    .then(function(notifications) {
                        try {
                            ...
                            for (var i=0; i<notifications.entities.length; i++) {
                                ...
                                if (!entity.schema) {
                                    console.log('[NOTIFICATIONS] **WARNING** Notification ' + entity.id + ' does not have a defined schema!');
                                    continue;
                                }
                            ...
                            fs.writeFileSync(binDir + '/notificationMappings.json', JSON.stringify(notificationMappings, null, 2));
